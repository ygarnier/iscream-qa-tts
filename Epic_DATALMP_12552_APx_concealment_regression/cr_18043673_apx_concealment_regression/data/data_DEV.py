...
if global_regression.TEST_SYSTEM == "DEV":
    global_regression.ATID = '09CC2B44'
else:
    global_regression.ATID = '09CC2B44'
...
OFFICE_AIDL_S72 = "UUSS72021"  # AIDL
OFFICE_TEST = "HDQLH1FTV"
...
# from Stratos
flightQR = generic_lib.AirSegment('QR', '979', 'Y',generic_lib.get_date("", "DDMMMYY", "DDMMMYY", offset=50), 'HKT', 'DOH', "", "")
